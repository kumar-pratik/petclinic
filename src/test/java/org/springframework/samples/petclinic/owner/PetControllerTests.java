...
class PetControllerTests {
	...
	void testInitCreationForm() throws Exception {
		mockMvc.perform(get("/petclinic/owners/{ownerId}/pets/new", TEST_OWNER_ID)).andExpect(status().isOk())
				.andExpect(view().name("pets/createOrUpdatePetForm")).andExpect(model().attributeExists("pet"));
	}

	@Test
	void testProcessCreationFormSuccess() throws Exception {
		mockMvc.perform(post("/petclinic/owners/{ownerId}/pets/new", TEST_OWNER_ID).param("name", "Betty")
	...
	void testInitUpdateForm() throws Exception {
		mockMvc.perform(get("/petclinic/owners/{ownerId}/pets/{petId}/edit", TEST_OWNER_ID, TEST_PET_ID))
	...
	void testProcessUpdateFormSuccess() throws Exception {
		mockMvc.perform(post("/petclinic/owners/{ownerId}/pets/{petId}/edit", TEST_OWNER_ID, TEST_PET_ID)
				.param("name", "Betty").param("type", "hamster").param("birthDate", "2015-02-12"))
				.andExpect(status().is3xxRedirection()).andExpect(view().name("redirect:/petclinic/owners/{ownerId}"));
	}
